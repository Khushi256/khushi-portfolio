...
const projects = [
    ...
    },
    {
        ...
        description: 'Deep learning crop diagnostics app built with PyTorch and Streamlit. Employs a custom CNN and ResNet18 transfer learning on 87,000+ leaf images across 38 classes, achieving up to 100% accuracy.',
        tags: ['PyTorch', 'Streamlit', 'Python', 'CNN', 'ResNet18'],
        image: '/images/plant-disease-detector.png',
        github: 'https://github.com/Khushi256/plant-disease-detector',
        live: 'https://plant-disease-detector-ml.streamlit.app/'
    },
    {
        number: '03',
        title: 'ReflectIQ',
...
function Projects() {
    return (
        <section
            className="relative bg-primary text-white transition-colors duration-300 py-20 md:py-32"
            id="projects"
        ...
        >
            <div className="max-w-7xl mx-auto px-6 w-full">
                ...
                <div className="mb-12 md:mb-20">
                    <motion.h2
                        className="font-display text-[11vw] md:text-[8vw] leading-none font-extrabold tracking-tighter uppercase"
                    ...
                    <motion.p
                        className="text-base md:text-xl text-zinc-400 max-w-lg mt-4 md:mt-6"
                ...
                <div className="flex flex-col gap-16 md:gap-24">
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            {/* Image side */}
                            <motion.div
                                className="h-[45vw] max-h-[320px] md:max-h-none md:h-[55vh] lg:h-[65vh] w-full flex items-center justify-center order-1 md:order-2"
                                whileHover={{ scale: 1.02, transition: { duration: 0.35, ease: 'easeOut' } }}
                            >
                                <img
                                    src={project.image}
                                    alt={project.title}
                                    className="max-w-full max-h-full object-contain rounded-2xl md:rounded-3xl shadow-[0_0_40px_rgba(255,255,255,0.3)] transition-shadow duration-300 hover:shadow-[0_0_60px_rgba(255,255,255,0.45)]"
                                />
                            </motion.div>
                        </motion.div>
                    ))}
